...
var UserWhere = struct {
	...
	TelegramID:       whereHelperint64{field: "\"user\".\"telegram_id\""},
...
var (
	userAllColumns            = []string{"id", "telegram_id", "first_name", "last_name", "telegram_username", "language_code", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"telegram_id", "first_name", "created_at"}
	userColumnsWithDefault    = []string{"id", "last_name", "telegram_username", "language_code", "updated_at"}
